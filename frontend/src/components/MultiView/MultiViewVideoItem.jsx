            ...
            {status === 'error' && (
                <div className="absolute inset-0 flex flex-col items-center justify-center bg-gray-100/95 dark:bg-black/90">
                    <div className="text-center p-4 max-w-xs">
                        <div className={`w-10 h-10 mx-auto mb-2 rounded-full flex items-center justify-center ${errorType === 'codec' || errorType === 'stalled' ? 'bg-yellow-500/20' : 'bg-red-500/20'
                            }`}>
                            {errorType === 'codec' || errorType === 'stalled' ? (
