...
export function Skeleton({ className = '', variant = 'default', ...props }) {
    ...
    const baseClasses = `${pulseClass} bg-edge/50 rounded`;
...
export function CameraCardSkeleton() {
    return (
        <div className="bg-surface-raised backdrop-blur-sm border border-edge/50 rounded-xl overflow-hidden">
    ...
    return (
        <div className="overflow-x-auto">
            <table className="w-full">
                <thead className="bg-surface-raised border-b border-edge-strong">
                    <tr>
                        {Array.from({ length: columns }).map((_, index) => (
...
export function StatCardSkeleton() {
    return (
        <div className="bg-surface-raised backdrop-blur-sm border border-edge/50 rounded-xl p-6">
...
export function ListItemSkeleton() {
    return (
        <div className="flex items-center gap-4 p-4 border-b border-edge/50">
