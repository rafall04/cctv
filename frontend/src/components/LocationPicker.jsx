    ...
    return (
        <div className="relative">
            <div className="relative">
                ...
                />
                <div className="absolute left-2.5 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-300">
                    {loading ? (
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3 text-sm">
                        {position ? (
                            ...
                            <span className="text-gray-500 dark:text-gray-400 italic text-xs">Belum ada koordinat</span>
                        )}
                    </div>
    ...
    return (
        <div className="space-y-2">
            <div className="flex items-start gap-2">
                ...
                <div
                    className="inline-flex rounded-lg border border-gray-200 bg-white/95 p-1 shadow-sm dark:border-gray-700 dark:bg-gray-900/90"
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3 text-xs">
                    {position ? (
                        ...
                        <span className="text-gray-500 dark:text-gray-400 italic">Belum ada koordinat</span>
                    )}
                </div>
                <div className="flex items-center gap-2">
                    {position && (
                    ...
                    <button
                        ...
                        className="text-xs text-gray-600 hover:text-gray-800 dark:text-gray-300 dark:hover:text-white font-medium"
                    >
                        Tutup Peta
                    </button>
                </div>
