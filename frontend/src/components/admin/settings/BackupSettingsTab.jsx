/*
Purpose: Admin settings panel for JSON backup export, preview, and restore import.
Caller: UnifiedSettings backup tab.
Deps: React, ../../../services/api, lucide-react.
MainFuncs: BackupSettingsTab.
SideEffects: Downloads backup files, previews/imports backup data, and reloads the page after import.
*/
