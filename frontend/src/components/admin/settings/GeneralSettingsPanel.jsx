                ...
                >
                    <Field label="Hero Badge Text" htmlFor="landing_hero_badge">
                        <input
                            ...
                            className="w-full rounded-xl border border-edge-strong bg-surface px-4 py-2.5 text-base sm:text-sm text-content transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:-outline-offset-1 focus-visible:outline-primary"
                        />
                    </Field>
                    ...
                    <Field label="Area Coverage Text" htmlFor="landing_area_coverage">
                        <textarea
                            ...
                            className="w-full resize-none rounded-xl border border-edge-strong bg-surface px-4 py-2.5 text-base sm:text-sm text-content transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:-outline-offset-1 focus-visible:outline-primary"
                        />
                    </Field>
                </SectionCard>
