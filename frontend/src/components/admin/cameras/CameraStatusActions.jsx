    ...
    return (
        <>
            <div className="flex items-center justify-between pt-4 border-t border-edge">
                <span className="text-xs text-content-subtle">ID: {camera.id}</span>
            ...
            <div className="flex items-center justify-between pt-3 mt-3 border-t border-edge">
                <span className="text-xs text-content-muted">Stream source</span>
                <button
                    type="button"
