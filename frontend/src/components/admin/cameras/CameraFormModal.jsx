        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-modal p-4 overflow-y-auto">
            ...
            >
                ...
                <form onSubmit={onSubmit} className="p-4 sm:p-6 space-y-4 overflow-y-auto flex-1">
                    ...
                    {loadingDetail && (
                        <div className="flex items-center gap-2 rounded-xl border border-primary-300 bg-primary-100 px-3 py-2 text-xs text-primary border-primary-300 dark:bg-primary/10 text-primary">
