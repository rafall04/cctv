        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-modal p-4 overflow-y-auto">
            ...
            >
                ...
                <form onSubmit={onSubmit} className="p-4 sm:p-6 space-y-4 overflow-y-auto flex-1">
                    ...
                    {loadingDetail && (
                        <div className="flex items-center gap-2 rounded-xl border border-sky-200 bg-sky-50 px-3 py-2 text-xs text-sky-700 dark:border-sky-500/20 dark:bg-primary/10 dark:text-sky-300">
