        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
            <div className="space-y-3 lg:col-span-2">
                <div className="flex items-center justify-between">
                    <h3 className="font-semibold text-content">Kode Promo</h3>
                            ...
                            <Card key={p.id} className="flex flex-wrap items-center gap-x-4 gap-y-2">
                                <div className="min-w-0 flex-1">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="rounded-full bg-primary-100 px-2 py-0.5 text-xs font-medium text-primary dark:bg-sky-900/40">{{ percent: 'Persen', flat: 'Flat', gift: 'Hadiah' }[p.type] || p.type}</span>
                                    </div>
                                ...
                                <div className="flex gap-1">
                                    <button onClick={() => toggleActive(p)} disabled={busy} className="rounded-lg border border-edge px-2 py-1 text-xs text-content-muted hover:bg-surface-sunken disabled:opacity-50">
