...
export function MonetagPopunder() {
    ...
    useEffect(() => {
        ...
        invokeScript.src = `/api/proxy/monetag/${config.popunder.zoneId}/invoke.js`;
...
export function MonetagNativeBanner({ className = '' }) {
    ...
    useEffect(() => {
        ...
        const invokeScript = document.createElement('script');
        invokeScript.type = 'text/javascript';
        invokeScript.src = `/api/proxy/monetag/${config.nativeBanner.zoneId}/invoke.js`;
        invokeScript.async = true;
...
export function MonetagBanner({ size = 'leaderboard', className = '' }) {
    ...
    useEffect(() => {
        ...
        const invokeScript = document.createElement('script');
        invokeScript.type = 'text/javascript';
        invokeScript.src = `/api/proxy/monetag/${config.directLink.zoneId}/invoke.js`;
        invokeScript.async = true;
        containerRef.current.appendChild(invokeScript);
...
export function MonetagSocialBar() {
    ...
    useEffect(() => {
        ...
        const invokeScript = document.createElement('script');
        invokeScript.type = 'text/javascript';
        invokeScript.src = `/api/proxy/monetag/${config.socialBar.zoneId}/invoke.js`;
        invokeScript.async = true;
        document.body.appendChild(invokeScript);
