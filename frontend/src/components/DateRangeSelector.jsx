/*
 * Purpose: Provide dashboard date range preset and custom-date selection using configured local date limits.
 * Caller: Dashboard filters.
 * Deps: React state and TimezoneContext date helper.
 * MainFuncs: DateRangeSelector.
 * SideEffects: Calls onChange when the selected date range changes.
 */
