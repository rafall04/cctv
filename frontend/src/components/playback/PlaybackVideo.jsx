...
export default function PlaybackVideo({
    ...
    const getErrorInfo = () => {
        const errors = {
            ...
            // Sudah pernah ter-decode lalu berhenti: perangkatnya JELAS mampu, jadi menyuruhnya
            // pindah browser adalah kebohongan. Kuning, bukan merah - ini bukan fault sejati.
            stalled: {
                title: 'Pemutaran Terhenti',
                desc: 'Video berhenti saat memuat data. Biasanya sementara - coba putar ulang.',
                color: 'yellow',
                icon: (
    ...
    return (
        <div className="bg-surface-raised rounded-card overflow-hidden shadow-e1">
            ...
            <div className="aspect-video bg-black relative overflow-hidden" ref={containerRef}>
                ...
                {videoError && (
                    /* z-40: kontrol kecepatan & snapshot memakai z-30, jadi tanpa ini keduanya
                       mengambang DI ATAS panel galat dan tetap bisa diklik menembusnya. */
                    <div className="absolute inset-0 z-40 flex items-center justify-center bg-black/90 p-8">
