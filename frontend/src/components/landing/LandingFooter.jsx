                ...
                <div className="mb-8 grid grid-cols-1 gap-8 md:grid-cols-3">
                    ...
                    <div className="text-center md:text-right">
                        ...
                        <a
                            ...
                            /* green-700, not -600: white on green-600 measures 3.3 against the 4.5
                               WCAG AA asks for; one step darker reaches ~5.0 and still reads as the
                               WhatsApp green. Caught by e2e/contrast.spec.js. */
                            className="inline-flex items-center gap-2 rounded-control bg-green-700 px-5 py-3 text-white transition-colors hover:bg-green-800"
                        >
