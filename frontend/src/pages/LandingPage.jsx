...
// Skeleton loaders
import { GridSkeleton, CameraCardSkeleton, VideoSkeleton } from '../components/ui/Skeleton';
// Empty states
...
// ============================================
function Navbar({ branding, layoutMode, onLayoutToggle }) {
...
// ============================================
function FilterDropdown({ selected, onChange, kecamatans = [], kelurahans = [] }) {
...
// ============================================
function CamerasSection({ onCameraClick, onAddMulti, multiCameras, viewMode, setViewMode, landingSettings = { section_title: 'CCTV Publik' } }) {
...
// ============================================
function Footer({ saweriaEnabled, saweriaLink, branding }) {
    const { cameras, areas } = useCameras();
    const cameraCount = cameras?.length || 0;
...
// ============================================
function StatsBar({ onCameraClick }) {
    const { cameras, areas } = useCameras();
...
function LandingPageContent() {
    ...
    const { cameras, areas, loading, deviceTier } = useCameras();
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                // Fetch Saweria config and landing settings in parallel
    ...
    return (
        <>
            <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex flex-col">
                <Navbar branding={branding} layoutMode={layoutMode} onLayoutToggle={toggleLayoutMode} />
                ...
                <header className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-transparent to-purple-500/10 dark:from-primary/5 dark:to-purple-500/5">
                    ...
                    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 text-center">
                        ...
                        <StatsBar onCameraClick={setPopup} />
                    </div>
                </header>
