        ...
        return (
            <div className="flex items-center justify-center min-h-screen bg-gray-50 dark:bg-gray-950">
                <div className="text-center">
                    <p className="text-gray-600 dark:text-gray-400 mb-4">Tidak ada kamera dengan recording enabled</p>
                    <a href="/admin/cameras" className="text-primary-500 hover:text-primary-600">
                        Aktifkan recording di Camera Management
                    </a>
                </div>
            </div>
        );
