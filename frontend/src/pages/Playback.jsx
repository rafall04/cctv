                ...
                <div className="bg-white dark:bg-gray-900 rounded-lg sm:rounded-xl overflow-hidden shadow-lg">
                    ...
                    {seekWarning && (
                        <div className="relative z-50 p-3 sm:p-4">
                            <div className="bg-blue-500 text-white px-4 sm:px-5 py-3 sm:py-4 rounded-xl shadow-2xl border-2 border-blue-400">
                                <div className="flex items-start gap-3">
                                    <svg className="w-6 h-6 sm:w-7 sm:h-7 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                        <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                                    </svg>
                                    <div className="flex-1 min-w-0">
                                        <p className="font-bold text-sm sm:text-base mb-1">ℹ️ Info Lompat Video</p>
                                        <p className="text-xs sm:text-sm mb-2">{seekWarning.message}</p>
                                        {seekWarning.remaining && (
                                            <div className="bg-blue-600 px-3 py-2 rounded-lg mt-2">
                                                <p className="text-xs sm:text-sm font-medium">📍 {seekWarning.remaining}</p>
                                            </div>
                                        )}
