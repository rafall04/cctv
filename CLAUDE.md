...
- **[docs/frontend-guide.md](docs/frontend-guide.md)** — React conventions **and the semantic design-token
  system** (surface/edge/content/status roles, status-dot semantics, public-surface honesty rules,
  mobile-viewport hard rules): structure, hooks/race-condition rules, view-mode/URL-param/share-link
  patterns, frontend perf. Read when doing ANY frontend or UI-styling work.
