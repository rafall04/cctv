...
- Public growth discovery: `/area/:areaSlug` and landing trending sections use sanitized `/api/public/*` area/trending endpoints and existing public video popup behavior.
