 ...
 * Caller: playbackTrialService, playbackOrderService, playbackAccessController (public list + admin edit).
 * Deps: connectionPool, playbackTokenService.
 * MainFuncs: listPublic, listAll, getByKey, getById, updateProduct, issueTokenForProduct.
