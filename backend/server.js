...
import publicBillingRoutes from './routes/publicBillingRoutes.js';
import publicCameraFeedbackRoutes from './routes/publicCameraFeedbackRoutes.js';
import publicPlaybackTelemetryRoutes from './routes/publicPlaybackTelemetryRoutes.js';
...
await fastify.register(publicBillingRoutes, { prefix: '/api/public/billing' });
await fastify.register(publicCameraFeedbackRoutes, { prefix: '/api/public/cameras' });
await fastify.register(publicPlaybackTelemetryRoutes, { prefix: '/api/public/playback-telemetry' });
